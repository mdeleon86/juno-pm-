...
Input: Slack thread SLACK-4421 reports that multiple users cannot export large reports and receive no error message. Jira ticket ROCKET-318 confirms the export job times out on large datasets.

Output: Rank 1 | High risk | Large report exports fail without user feedback | SLACK-4421, ROCKET-318 | Investigate export timeout and add clear failure messaging.
