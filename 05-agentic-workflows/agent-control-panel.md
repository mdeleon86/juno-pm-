...
Agent can draft a P0 risk summary and Jira stub, but PM approval is required before Juno posts to Slack or creates any Jira item. Agent CANNOT auto-close threads or DM customers.
...
READ: Slack #escalations, Strategy KB, Salesforce ARR. DRAFT: #pm-daily posts and Jira stubs only. PM approval is required before posting to Slack or creating any Jira item. CANNOT edit Salesforce or post outside #pm-daily.
